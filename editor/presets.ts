...
const colorsDefault: Colors = {
  ...
  colorSlopeTop: ['#d0d0d0', '#b0b0b0'],
  // colorSlopeLeft: ['#c8c8c8', '#a8a8a8'],
  colorSlopeLeft: '#c1c2c2',
  colorSlopeRight: ['#b0b0b0', '#909090'],
  colorSlopeTopRight: ['#e0e0e0', '#c0c0c0'],
  colorSlopeBottom: ['#b0b0b0', '#909090'],
  colorFaceBottom: ['#d8d8d8', '#b8b8b8'],
  colorFaceUpper: ['#d8d8d8', '#b8b8b8'],
  colorFaceFront: ['#d8d8d8', '#b8b8b8'],
