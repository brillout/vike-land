...
const presetsColor: Record<string, Colors> = {
  ...
  brightRevived2: (() => {
    ...
    return {
      metalCorner: 'red',
      metalSlope: colorSlopeRight,
      metalFace: colorSlopeRight,
      metalTop: 'red',
      metalBottom2: 'red',
      metalBottom: ['#c7c7c7', '#949494'],
      wood: ['#ffb152', '#aa5422'],
  ...
  brightRevived: (() => {
    const colorMain = '#c4c4c4'
    return {
      metalCorner: 'red',
      metalSlope: colorMain,
      metalFace: '#dcdbdb',
      metalTop: 'red',
      metalBottom2: 'red',
      ...
      colorSlopeTop: ['#dedede', colorMain],
      colorSlopeLeft: '#e6e6e6',
      colorSlopeRight: ['#9e9e9e', '#9e9e9e'],
      colorSlopeTopRight: '#dcdbdb',
  ...
  bright2: {
    ...
    colorSlopeTop: ['#dedede', '#c9c9c9'],
    colorSlopeLeft: '#e6e6e6',
    colorSlopeRight: ['#adadad', '#c9c9c9'],
    colorSlopeTopRight: '#c9c9c9',
    colorSlopeBottom: ['#b8b8b8', '#8a8a8a'],
    colorFaceRight: '#ababab',
    colorFaceUpper: ['#c9c9c9', '#a8a8a8'],
    colorFaceFront: ['#d9d9d9', '#b0afaf'],
    colorCornerTopLeft: '#dedede',
    colorCornerTopRight: '#c9c9c9',
    colorCornerBottomRight: '#7d7d7d',
    colorCornerBottomLeft: '#dedede',
  },
  bright: {
